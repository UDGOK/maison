"""Maison Giveaway (v0.6 Q) — product giveaways with entries earned at the counter.

Entries are ``Maison Giveaway Entry`` rows created on Sales Invoice submit (1 entry per $X of net
