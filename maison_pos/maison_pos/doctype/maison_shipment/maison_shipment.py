"""Maison Shipment (v0.6 P): one warehouse → store consignment.
...
``Maison Receiving Discrepancy`` for the warehouse admin. All transitions go through
