"""AWANZ Client Profile (v0.4): clienteling data linked 1:1 to a Customer."""
...
class AWANZClientProfile(Document):
	def validate(self) -> None:
		...
		if self.preferred_associate and self.preferred_boutique:
			assoc_boutique = frappe.db.get_value("AWANZ Associate", self.preferred_associate, "boutique")
	...
	def _sync_contact(self) -> None:
		...
		try:
			...
			frappe.log_error(frappe.get_traceback(), "awanz profile contact sync")
