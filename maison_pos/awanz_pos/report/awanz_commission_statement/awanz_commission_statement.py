"""AWANZ Commission Statement — totals per associate (or every entry with *detail*)."""
...
def execute(filters=None):
	...
	if filters.get("detail"):
		columns = [
			...
			{"label": _("Boutique"), "fieldname": "boutique", "fieldtype": "Link", "options": "AWANZ Store", "width": 100},
			{"label": _("Item"), "fieldname": "item_code", "fieldtype": "Link", "options": "Item", "width": 110},
			{"label": _("Rule"), "fieldname": "rule", "fieldtype": "Link", "options": "AWANZ Commission Rule", "width": 180},
	...
	columns = [
		{"label": _("Associate"), "fieldname": "associate", "fieldtype": "Link", "options": "AWANZ Associate", "width": 220},
