...
from maison_pos.scoping import assert_boutique_access, assert_roles, get_user_boutique, is_unrestricted, ALL_MAISON_ROLES
...
def connection_token(boutique: Optional[str] = None) -> dict[str, Any]:
	...
	location = frappe.db.get_value("Maison Boutique", boutique, "stripe_location_id")
