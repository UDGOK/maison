...
await set('AWANZ Replenishment Request', rW.name, 'requested_at', hoursAgo(5))
...
await set('AWANZ Replenishment Request', rC.name, 'requested_at', hoursAgo(30))
...
await set('AWANZ Shipment', toPick.ship, 'approved_at', hoursAgo(6))
...
writeFileSync('/home/claude/awanz/e2e/qa/state.json', JSON.stringify(out, null, 1))
